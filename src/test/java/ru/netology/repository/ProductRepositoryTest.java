...
class ProductRepositoryTest {
    ...
    Book bookOne = new Book(1, "Красная таблетка", 700, "Курпатов А.");
    Book bookTwo = new Book(2, "1984", 300, "Оруэлл Д.");
    SmartPhone smartPhoneOne = new SmartPhone(3, "Mi 9 lite", 12000, "Xiaomi");
